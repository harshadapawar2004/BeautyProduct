...
const FilterSidebar = ({ category,handleCategory, price, setPrice }) => {
  return (
    <aside className="w-full md:w-[320px] h-fit sticky top-5 bg-white/10 backdrop-blur-2xl border border-white/10 rounded-[35px] p-8 shadow-[0_10px_40px_rgba(0,0,0,0.4)]">
      ...
      <div className="flex items-center gap-4 mb-10">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-white">Filters</h1>
      ...
      <div className="flex flex-col gap-6">
        <h2 className="text-2xl font-bold text-white">Beauty Categories</h2>
        ...
        <ul className="flex flex-col gap-5">
          ...
          <li className="group flex items-center justify-between bg-black/30 border border-white/10 hover:border-pink-500 rounded-2xl px-5 py-4 transition duration-300 cursor-pointer" >
            ...
            <input
              ...
              checked={category.includes("facewash")}
              readOnly
              onClick={() => handleCategory("facewash")}
            />
          </li>
          ...
          <li className="group flex items-center justify-between bg-black/30 border border-white/10 hover:border-pink-500 rounded-2xl px-5 py-4 transition duration-300 cursor-pointer">
            ...
            <input
              type="checkbox"
              className="w-5 h-5 accent-pink-500"
              checked={category.includes("bodywash")}
              readOnly
              onClick={() => handleCategory("bodywash")}
            />
          </li>
      ...
      {/* PRICE FILTER */}
      <div className="mt-10">
        <h2 className="text-2xl font-bold text-white mb-6">Price Range</h2>
